	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
                ...
                <div style="text-align:center; font-family: Poppins-Regular; font-size:30px;font-weight:bold; margin-top:20px">Login</div>
				<form id="form_login" method="POST" class="login100-form validate-form">
					{{ csrf_field() }}
					<div class="wrap-input100 m-b-26" data-validate="Masukan email">
						<span class="label-input100">Email</span>
						<input class="input100" type="text" id="email" name="email" placeholder="Masukan Email">
						<span class="focus-input100"></span>
					</div>

					<div class="wrap-input100 m-b-18" data-validate = "Masukan Password">
					...
					success: function( res ){
						if(res.error == 1){
						  ...
						  if(res.message.password != null){
							...
							new PNotify({
								title: 'Success',
								text: 'Login Success <br><b><i>' + res.pengurus,
								type: 'success',
								icon: "fa fa-check",
								delay:500,
