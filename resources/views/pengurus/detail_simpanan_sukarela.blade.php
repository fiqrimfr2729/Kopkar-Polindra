                      ...
                      <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a data-target="#modalDelete" data-id_sukarela="{{$data->id_simpanan_sukarela}}" data-toggle="modal" class="btn ripple-infinite btn-danger" data-placement="top" title="Hapus"><span class="fas fa-trash"></span></a>
                            </td>
                        </tr>
                        @endforeach
