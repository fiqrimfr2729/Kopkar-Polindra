                      ...
                      <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{route('detail_simpanan_anggota',['no_anggota'=>$data->no_anggota])}}" class=" btn ripple-infinite btn-info" data-placement="top" title="Detail"><span class="fas fa-list"></span></a>
                            </td>
                        </tr>
                        @endforeach
                      </tbody>
