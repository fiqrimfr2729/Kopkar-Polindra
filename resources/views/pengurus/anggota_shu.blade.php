                      ...
                      <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{route('detail_simpanan_sukarela',['no_anggota'=>$data->no_anggota])}}" class=" btn ripple-infinite btn-info" data-placement="top" title="Detail"><span class="fas fa-list"></span></a>
                            </td>
                        </tr>
                        @endforeach
                      </tbody>
              ...
              <form id="modalFormCreate" action="" method="POST">
                ...
                <div class="form-group">
                  ...
                  <select name="tahun" id="tahun" class="form-control">
                    ...
                    <option value="2018" name="tahun" >2018</option>
                    <option value="2019" name="tahun" >2019</option>
                    <option value="2020" name="tahun" >2020</option>
                    <option value="2021" name="tahun" >2021</option>
                    <option value="2022" name="tahun" >2022</option>
    ...
    <script type="text/javascript">
        var formCreate = $('#modalFormCreate');
            formCreate.submit(function (e) {
                ...
                e.preventDefault();
                $.ajax({
                    url: '/pengurus/simpanan_sukarela_create',
                      ...
                      if( res.error == 0 ){
                        ...
                        swal(
                          ...
                          res.message,
                            ...
                            if(OK){
                                window.location.href = "{{ route('simpanan_sukarela_anggota') }}";
                            }
                          });
                      }else{
                          $('#modalCreate').modal('hide');
